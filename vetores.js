...
//Forma 1: push() -> adiciona novos elemento ao FINAL do vetor
vetor1.push('laranja')
vetor1.push('limão')

console.log(vetor1)

// Forma2 : unshift() -> adicona novos elementos no INICIO do vetor
vetor1.unshift('maçã')
console.log(vetor1)
...
// Forma 1: pop() -> retira o últimno elemento do vetor
let x1 = vetor1.pop()
...
// Forma 2: for..of
// Percorre o vetor do primeiro ao último elemento de uma forma
